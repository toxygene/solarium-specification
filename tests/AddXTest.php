...
class AndXTest extends TestCase
{
    ...
    public function testFilterIsBuiltFromChildren()
    {
        ...
        $this->assertEquals('(a:b AND c:d)', $spec->getFilter($mockQuery));
    }
    ...
    public function testModifyIsCalledOnChildren()
    {
        ...
        $spec = new AndX([$mockQueryModifier1, $mockQueryModifier2]);
